...
VH3 AI is priced on the volume of visits enriched, not on the number of seats. Every tier includes unlimited users. Plans start at Core with the intelligence layer, Connie, AI agents, semantic search, and the operational graph — then scale through Core+, Connect, and Enterprise.
...
| | VH3 Core | VH3 Core+ | VH3 Connect | VH3 Enterprise |
|---|---|---|---|---|
| **Monthly price** | £995 | £1,995 | £2,995 | £9,995 |
| **Minimum term** | Month-to-month | 3 months | 3 months | Custom |
| **Visits included /month** | 1,000 | 2,500 | 5,000 | 10,000 |
...
| Semantic search + intelligence layer | ✓ | ✓ | ✓ | ✓ |
| Operational reporting + dashboards | ✓ | ✓ | ✓ | ✓ |
| Managed onboarding | ✓ | ✓ | ✓ | ✓ |
| Native integration layer | Not included | ✓ | ✓ | ✓ |
| User-based permissions + role mapping | Not included | ✓ | ✓ | ✓ |
| Advanced workflow automation | Not included | ✓ | ✓ | ✓ |
| VH3 Connect platform UI | Not included | Not included | ✓ | ✓ |
| Multi-agent orchestration + governance | Not included | Not included | ✓ | ✓ |
| Case management + audit trails | Not included | Not included | ✓ | ✓ |
| Embedded compliance | Not included | Not included | ✓ | ✓ |
| Lite White Glove TaaS (Systemise) | Not included | Not included | ✓ | Not included |
| Enterprise deployment programme (90-day) | Not included | Not included | Not included | ✓ |
| Dedicated programme manager | Not included | Not included | Not included | ✓ |
