...
Current package: [`n8n-nodes-vh3ai@0.12.0`](https://www.npmjs.com/package/n8n-nodes-vh3ai) (tag `v0.12.0`). Existing workflows keep working.
...
| **Email** | Classify · Batch Classify · Ingest General Email · Ingest Portal Email · List Triage Categories · List Triage Rules |
