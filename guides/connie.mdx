...
| Layer | Role | Typical speed | Uses conversational AI? |
|-------|------|---------------|-------------------------|
...
Depending on your set up and integrations, Connie can also drive **email drafts**, **notifications**, **briefings**, **account reports**, **presentations**, and lookups into connected systems (CRM, mail) through the same connected platform capabilities. See the [Connie API](/api-reference/connie) for endpoints and fields.
