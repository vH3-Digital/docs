...
- **Truncated tool payloads** return compact, LLM-ready shapes from feeds, search, and aggregates so context windows are not filled with empty fields and nested noise.
