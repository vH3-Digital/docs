...
This page is written for non-technical users. If you can brief a junior colleague, you can brief Connie.
...
Connie handles ambiguity well: "what is going on with Pure Gym?" or "any sites worth watching this week?" will get useful answers, because she reads your model, picks the right tools, and cites what she finds.

Treat her like a capable colleague who knows the operation but has not been in the room for the last conversation. Three habits make the difference between a good answer and a great one. Use them when the question matters.
...
Most of the work the platform does happens before any human opens a screen. It runs continuously against your data so the model is ready when someone asks a question, opens a report, or reads a sentinel digest.
...
- Customer summaries, semantic indexes, dashboard snapshots, and aggregations are prepared in advance so reads stay fast.
