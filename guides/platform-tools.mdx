...
| Tool | Endpoint | What it does |
|------|----------|--------------|
| Cases | `/cases/*` | Create cases, attach jobs and sentinel triggers, transition status, log activity, assign participants. Connie: `cases_for_entity`, `list_cases` (company catalogue; drafts excluded from list), `get_case`, `create_case`, `annotate_case` |
