...
[The harness is the product →](/guides/the-harness-is-the-product)
...
<CardGroup cols={2}>
  ...
  <Card title="The harness is the product" icon="gears" href="/guides/the-harness-is-the-product">
    Tools, integrations, memory, orchestration, oversight, and the quality loops that make production AI hold.
  </Card>
