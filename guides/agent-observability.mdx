...
Your app can render structured outputs without exposing internal field names to end users. The important thing is that **structured outputs are first-class**, not an afterthought.
