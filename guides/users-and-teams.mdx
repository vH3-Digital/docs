...
<Card title="Do this in Connect" icon="laptop" href="/connect/cases">
  Open Cases, assign an Assigned Team, and manage ownership groups — not Profile user invites.
</Card>
...
| Assign or clear Assigned Team | `POST /cases/{case_id}/assign-team` |
...
- **n8n workflows** use the [VH3 AI community node](/n8n-node) (`n8n-nodes-vh3ai@0.11.0`): Team for members and entity links, and Case › Assign Team to set or clear ownership (Team ID `0` clears it).
...
<CardGroup cols={2}>
  <Card title="Teams in Connect" icon="people-group" href="/connect/teams">
    Ownership groups, Assigned Team, and how they differ from product roles.
  </Card>
  <Card title="Cases in Connect" icon="folder-open" href="/connect/cases">
    Create Cases, link evidence, assign a Team, and follow activity.
  </Card>
  <Card title="Teams API" icon="people-group" href="/api-reference/teams">
  ...
  <Card title="n8n Community Node" icon="puzzle-piece" href="/n8n-node">
    Teams, Assign Team, Contact Feed, Quote Documents, and Salma on the verified community node.
  </Card>
