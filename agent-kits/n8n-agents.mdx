...
| **VH3 node + AI Tool** | 150+ operations (jobs, contacts, teams, cases, sentinels, reports, Connie, Salma, Quote Documents, email triage) with descriptions the agent reads at runtime |
| **Included on your plan** | Full n8n automation platform on Core and above; community node free to install |
...
- Show / list / find a job or account → job feed, contact feed, or search tools
- Similar past work / precedent → search outcomes, or search outcomes enriched when you need date/status filters and related context
- What needs attention / alerts → run sentinels
- Briefing / debrief / report → generate report
- Contact summary → Connie generate summary
- Assign case ownership → cases assign team (team ID 0 clears it)
- Draft a quote estimate for a job → Salma generate estimate (pass recipient emails)
