...
Never use: `weekly_summary`, `monthly_summary`, `daily_summary`, `daily_operations`, `month_review`, `end_of_month`, `executive_health_check`, `engineer_performance`, `site_health`, `customer_intelligence`, `sentinel_digest`.
