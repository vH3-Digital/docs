...
<CardGroup cols={2}>
  ...
  <Card title="n8n Node Reference" icon="book" href="/agent-kits/n8n-node-reference">
    Resource, operation, and routing reference for coding agents building VH3 n8n workflows (`n8n-nodes-vh3ai@0.11.0`).
  </Card>
