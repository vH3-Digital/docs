...
<Warning>
  ...
  there without exposing the key.

  Use only the base URL above for Teams. Never send `api_key` from browser or
  mobile code.
</Warning>
...
```bash
curl -G "https://api.vh3connect.io/api:kP8T1CK7/teams/42" \
  --data-urlencode "company_id=your-company-id" \
  --data-urlencode "api_key=your-api-key"
```
...
```bash
curl -X PATCH "https://api.vh3connect.io/api:kP8T1CK7/teams/42" \
  -H "Content-Type: application/json" \
  -d '{
    "company_id": "your-company-id",
    "api_key": "your-api-key",
...
```bash
curl -G "https://api.vh3connect.io/api:kP8T1CK7/teams/42/members" \
  --data-urlencode "company_id=your-company-id" \
  --data-urlencode "api_key=your-api-key"
```
...
| `role` | string | Yes | Role within team (`team_lead`, `manager`, `senior_member`, `member`, `observer`) |
...
```bash
curl -X POST "https://api.vh3connect.io/api:kP8T1CK7/teams/42/members" \
  -H "Content-Type: application/json" \
  -d '{
    "company_id": "your-company-id",
    "api_key": "your-api-key",
...
```bash
curl -X DELETE "https://api.vh3connect.io/api:kP8T1CK7/teams/42/members/99" \
  -H "Content-Type: application/json" \
  -d '{
    "company_id": "your-company-id",
    "api_key": "your-api-key"
...
```bash
curl -G "https://api.vh3connect.io/api:kP8T1CK7/teams/42/entities" \
  --data-urlencode "company_id=your-company-id" \
  --data-urlencode "api_key=your-api-key"
```
...
```bash
curl -X POST "https://api.vh3connect.io/api:kP8T1CK7/teams/42/entities" \
  -H "Content-Type: application/json" \
  -d '{
    "company_id": "your-company-id",
    "api_key": "your-api-key",
...
```bash
curl -X DELETE "https://api.vh3connect.io/api:kP8T1CK7/teams/42/entities/77" \
  -H "Content-Type: application/json" \
  -d '{
    "company_id": "your-company-id",
    "api_key": "your-api-key"
